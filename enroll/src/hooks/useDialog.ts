...
export default () => {
  ...
  const showApplySuccessDialog = ref(false);
  ...
  const closeAllDialog = () => {
    ...
    showApplySuccessDialog.value = false;
  };
  ...
  const openApplySuccessDialog = openDialog(() => {
    showApplySuccessDialog.value = true;
  }, false);
