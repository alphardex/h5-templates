...
export default () => {
  ...
  const showVoteSuccessDialog = ref(false);
  const showVoteNoChanceDialog = ref(false);
  ...
  const closeAllDialog = () => {
    ...
    showVoteSuccessDialog.value = false;
    showVoteNoChanceDialog.value = false;
  };
  ...
  const openVoteSuccessDialog = openDialog(() => {
    showVoteSuccessDialog.value = true;
  });

  const openVoteNoChanceDialog = openDialog(() => {
    showVoteNoChanceDialog.value = true;
  });
  ...
  return {
    ...
    showVoteNoChanceDialog,
    openVoteNoChanceDialog,
  };
};
