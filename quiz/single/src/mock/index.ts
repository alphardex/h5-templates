...
class MockServer {
  ...
  start() {
    ...
    mock.onGet(API.info).reply(200, {
      ...
      data: {
        title: "答题H5模板",
        description: "快来和我一起参与答题吧！",
        keywords: "",
        share_info: {
          title: "答题H5模板",
          desc: "快来和我一起参与答题吧！",
          img:
            "http://www.cs090.com/uploads/userup/a/817880/2021/1622421463-LWY8_100x100.jpg",
          url: "http://ime.happy2cs.com/4144295/",
        },
        act_rule: "<p>规则00</p>",
        begin_time: "1624464000",
        end_time: "1625241300",
      },
    });
    ...
    mock.onGet(API.questions).reply(200, {
      ...
      data: {
        ...
        question: {
          type: "1",
          question:
            "1.在“常熟智慧健康”服务平台内目前可以在常熟一院、常熟二院、常熟中医院、常熟三院、常熟五院可以（  ）",
          option: {
            A: "预约挂号",
            B: "当日挂号&#8226;",
            C: "预约转挂号",
    ...
    mock.onPost(API.submit).reply(200, {
      ...
      data: {
        ...
        next: {
          type: "2",
          question:
            "2.在“常熟智慧健康”服务平台内目前可以在常熟一院、常熟二院、常熟中医院、常熟三院、常熟五院可以（  ）",
          option: {
            A: "预约挂号2",
            B: "当日挂号&#8226;",
            C: "预约转挂号",
